...
<script type="text/javascript">
	$(function() {
		$("#fileinput1").fileinput({
			...
			maxFileSize : 30720,
			maxFileCount : 1,
			allowedFileExtensions : [ "rar", "zip", "7z", "pdf" ]
		});
	});
</script>
</head>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"> Add compressed file</li>
			</ol>
					...
					<div class="row clearfix">
						<div class="col-md-12 column">
							<div class="alert alert-dismissable alert-info"
								...
								<h4>Please upload lecture notes in .rar, .zip, .7z or .pdf
									formats</h4>
								<strong>Beware!</strong>uploaded files are limited in 30 MB each
								(30720KB).
							</div>
