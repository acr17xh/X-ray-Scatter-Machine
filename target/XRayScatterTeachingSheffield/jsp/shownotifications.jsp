		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Notifications&nbsp<label>${addsuccess}</label><label>${dataerror}</label><label>${delsuccess}</label>
				</div>
				<div class="card-body">
					<div class="row clearfix">
						<div class="col-md-12 column">
							<form action="${contextPath}/user/deletenotif">
							...
							<div class="row clearfix">
								...
								<div class="col-md-6 column">
									<ul class="pagination">
										<li><a
											href="${contextPath}/user/tonotifications?page=${pageinfo.firstPage}">First</a></li>&nbsp
										<li><a
											href="${contextPath}/user/tonotifications?page=${pageinfo.prePage}">Previous</a></li>&nbsp
										<li><a
											href="${contextPath}/user/tonotifications?page=${pageinfo.nextPage}">Next</a></li>&nbsp
										<li><a
											href="${contextPath}/user/tonotifications?page=${pageinfo.lastPage}">Last</a></li>&nbsp
									</ul>
								</div>
							</div>
						</div>
