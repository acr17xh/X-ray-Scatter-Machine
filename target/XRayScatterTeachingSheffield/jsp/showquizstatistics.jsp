				...
				function(e) {
					...
					$.ajax({
						...
						success : function(msg) {
							...
							if (delfail == "" || delfail == undefined
									|| delfail == null) {
								$("#delfail").hide();
								$("#delsuc").show();
							} else if (delsuc == "" || delsuc == undefined
									|| delsuc == null) {
								$("#delsuc").hide();
								$("#delfail").show();
							}
					...
					<div class="col-md-12 column">
						...
						<div class="row clearfix">
							...
							<div class="col-md-6 column">
								<ul class="pagination">
									<li><a
										href="${contextPath}/user/toquizstatistics?page2=${pageinfo2.firstPage}">First</a></li>&nbsp
									<li><a
										href="${contextPath}/user/toquizstatistics?page2=${pageinfo2.prePage}">Previous</a></li>&nbsp
									<li><a
										href="${contextPath}/user/toquizstatistics?page2=${pageinfo2.nextPage}">Next</a></li>&nbsp
									<li><a
										href="${contextPath}/user/toquizstatistics?page2=${pageinfo2.lastPage}">Last</a></li>&nbsp
								</ul>
							</div>
						</div>
					</div>
