					...
					<div class="row clearfix">
						<div class="col-md-12 column">
							<div class="alert alert-dismissable alert-info"
								...
								<h4>Add a sample</h4>
								<p>Input sample name and its camera length, with one image
									and short description of the sample. You can go to 'show
									existing samples' then add output for this sample.</p>
							</div>
							<form class="form-horizontal"
								...
								<div class="form-group">
									<div class="col-sm-10">
										<table>
											<tr>
												<td>Please choose one sample image, in JPEG format</td>
											</tr>
											<tr>
