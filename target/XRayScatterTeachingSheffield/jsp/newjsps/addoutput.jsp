	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Add output</li>
			</ol>

			<!-- Example DataTables Card-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i>Add output
				</div>
				<div class="card-body">
					...
					<div class="row clearfix">
						<div class="col-md-12 column">
							<div class="alert alert-dismissable alert-info"
								...
								<h4>Add outcome</h4>
								<p>You can upload outcome image with its description, or
									just upload images without descriptions.</p>
							</div>
							<form class="form-horizontal"
								action="${contextPath}/user/addoutput"
								enctype="multipart/form-data" method="post">
								<div class="form-group">
									<label for="inputoutputdes" class="col-sm-2 control-label">Outcome
										description</label>
									<div class="col-sm-10">
										<textarea class="form-control" rows="10" id="inputoutputdes"
											name="outputdes"></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10">
										<table>
											<tr>
												<td>Please choose one outcome image, in .jpg , .bmp or
													.png format</td>
											</tr>
											<tr>
							...
							<label>Upload images with a specific title (sample
								name+"_"+exposure time,for example: "sampleone_30.jpg"), 5
								images allowed each time.</label>
