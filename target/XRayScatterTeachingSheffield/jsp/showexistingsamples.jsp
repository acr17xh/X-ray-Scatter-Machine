	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Show existing samples</li>
			</ol>

			<!-- Example DataTables Card-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Show existing samples&nbsp<label>${delsuccess}</label><label>${uploadsuccess}</label>
				</div>
				<div class="card-body">
					<div class="row clearfix">
						<div class="col-md-12 column">
							...
							<form action="${contextPath}/user/deletesample">
								<table class="table table-condensed table-hover">
									...
									<tbody>
										<c:forEach items="${samples}" var="sample">
											<tr>
												<td><a href="${contextPath}/simulation">${sample.sampleTil}
														cameralength:${sample.sampleCamlen}</a></td>
