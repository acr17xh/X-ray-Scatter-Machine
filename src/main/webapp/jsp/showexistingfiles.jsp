	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"> Show existing files</li>
			</ol>

			<!-- Example DataTables Card-->
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Show existing files&nbsp<label>${delsuccess}</label><label>${uploadsuccess}</label>
				</div>
				<div class="card-body">
					<div class="row clearfix">
						<div class="col-md-12 column">
							...
							<form action="${contextPath}/user/deletefile">
