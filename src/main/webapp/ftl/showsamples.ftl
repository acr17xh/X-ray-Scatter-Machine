...
<script src="${contextPath}/js/jquery-3.2.1.min.js"></script> <script
	src="${contextPath}/js/bootstrap.min.js"></script> <script
	src="${contextPath}/js/shop-item.css"></script> <script
	src="${contextPath}/js/bootstrap.bundle.min.js"></script>
</head>
<body>
	<!-- Navigation -->
			...
			<div class="col-lg-3">
				...
				<ul class="nav nav-tabs nav-stacked" data-spy="affix"
					...
					<li><#list samplelist as samples> <a
							...
							class="list-group-item">${samples.sampleTil!}</a> </#list></li>
				</ul>
			</div>
			<!-- sample item -->
			<div class="col-lg-9">
				<label>${outcomeerror!}</label>
				<#list samplelist as samples2>
				<div class="card mt-4">
					<img class="card-img-top img-fluid"
						src="${contextPath}/simulation/showsampleimg?imgid=${samples2.sampleId}"
						alt="Ooops,image missing!">
					<div class="card-body" id=${samples2.sampleId?string}>
						<h3 class="card-title">${samples2.sampleTil!}</h3>
						<h4 class="card-title">Camera length:
								${samples2.sampleCamlen!}</h4>
								<h4 class="card-title">Stage:
								${samples2.sampleStage!}</h4>
