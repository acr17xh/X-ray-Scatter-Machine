				...
				<div class="row">
					<div class="col-xs-3" id="myScrollspy">
						<ul class="nav nav-tabs nav-stacked" data-spy="affix"
							data-offset-top="125">
							<li class="active"><a href="lecturenotes#section-1">PART
									1</a></li>
							<li><a href="lecturenotes#section-2">PART 2</a></li>
							<li><a href="lecturenotes#section-3">PART 3</a></li>
							<li><a href="lecturenotes#section-4">PART 4</a></li>
							<li><a href="lecturenotes#section-5">PART 5</a></li>
							<li><a href="lecturenotes#section-6">Download</a></li>
						</ul>
					</div>
					<div class="col-xs-9">
