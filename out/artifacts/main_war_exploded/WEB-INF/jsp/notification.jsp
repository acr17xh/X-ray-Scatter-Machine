			...
			<div class="col-md-12 column">
				...
				<div class="col-md-6 column">
					<ul class="pagination pagination-sm">
						<li><a
							href="displaynotifs?page=${pageinfo.firstPage}#notiftable">First</a></li>
						<li><a
							href="displaynotifs?page=${pageinfo.prePage}#notiftable">Prev</a></li>
						<li><a
							href="displaynotifs?page=${pageinfo.nextPage}#notiftable">Next</a></li>
						<li><a
							href="displaynotifs?page=${pageinfo.lastPage}#notiftable">Last</a></li>
					</ul>
				</div>
			</div>
		</div>
